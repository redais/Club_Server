...
#   DB_password = hash(club_password, DB_club_salt)
# If your database were to be compromised you'd be vulnerable to a dictionary
# attack on all your stupid clubs' passwords.  With a site key, we store
#   DB_password = hash(club_password, DB_club_salt, Code_site_key)
...
REST_AUTH_SITE_KEY         = '0892fb806e1f7f2aa2f712783a0d15c8782f990b'
